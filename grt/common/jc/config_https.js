var HOST={
	...
	,redirect:"http://192.168.28.125/work/grt/"
	...
	,source:"//a-h5.mtq.tvm.cn/yao/common/"
	,bangdan:"share.html"
	,loading:"爽宝正在为您加载数据"
	,pusher:false       //推送大屏幕
	,yanzheng:0		//手机验证
...
function instance($data){
	...
	var cc=eval("("+PAGE.MENU+")");
	PAGE.MENU=[{"value":"//a-h5.mtq.tvm.cn/yao/common/img/menu/m_djbd.png","type":"file","noteText":"M_HBBD","name":"option0"}]
	CONFIG.chars.share={
		a:"邀请你一起来玩"+PAGE.channelName+"摇一摇"
		,b:"锁定"+PAGE.channelName+"频道"
		,c:"微信摇一摇"
