...
,WARTER:function($opt){
	...
	,i=0,mtime,gtime
	,module=+$opt.module||0
	,msgc=[.1,.4,.6,.3,0,.2,.5,.7,.9,0,1,.11,.42,0,.35,.81,.26,.55,.74,.89]
	,msgA=[]
	,getData
	,runSocket
	,socket
	,method={
		create:function(head,name){
			var zm = document.createElement("div");
			zm.className="ball";
			warte_wrap.appendChild(zm);
			zm.innerHTML='<img src="'+getHead(head)+'"><div class="partName">'+decodeURIComponent(name)+'</div>';
			return zm
		},
		set:function (){
			getData();
			mtime=setInterval(move,600);
		...
		getData=function(){
			if(runSocket){
				return 0
				    ...
				    //测试socket地址 115.159.16.95
					//测试socket地址 120.27.82.154
					HOST.SOCKET="115.159.16.95";
	...
	function move(){
		var txt=msgA.shift()
			if(txt){
			 var time=Math.ceil((Math.random()*20*200+4000)),tao=method.create(txt.headImg,txt.data),r=Math.random(),l=msgc.length*r>>0
			setTimeout(function(){
					if(i>5){i=0;}
					tao.style.webkitTransition='all '+time+'ms linear';	
					var leftValue=Math.floor(msgc[l]*winW);
					i++
					tao.style.webkitTransform="translate3d("+leftValue+"px,-80px,0)";					
					setTimeout(zmA,time);			
					function zmA(){		
...
,CASTBALANCE:function(json){
		var CSS_s='.enterCon.up,.makeVow{position:absolute;bottom:150px;right:-30px;height:75px;width:120px;z-index:10008}.makeVow img{height:100%;width:100%;position:absolute;}.makeVow .before{z-index:1;}.enterCon.up{opacity:0}.enterCon.up input{width:100%;height:100%}.enterCon.up{-webkit-user-modify:read-write-plaintext-only;-webkit-tap-highlight-color:transparent}.enterCon.down{opacity:1;position:fixed;width:100%;height:46px;padding-top:8px;background:#d3d3d5;z-index:10001;bottom:0}.enterCon input{font:14px weiruanyahei,FZYQJW,"微软雅黑",Tahoma,"\534E\6587\5B8B\4F53",arial;border:none;color:#898989;border-radius:8px;vertical-align:middle;display:block;width:90%;padding-left:3%;margin:0 auto;height:30px;line-height:30px}#coin_wrap{position:absolute;top:0;height:100%;width:100%;overflow:hidden;z-index:3}#coin_wrap>div{position:absolute;width:22px;height:22px;-webkit-animation-iteration-count:1,1;-webkit-animation-direction:normal,normal;-webkit-animation-timing-function:linear,ease-in}#coin_wrap>div>img{position:absolute;width:22px;height:22px;background-size:100% 100%;-webkit-animation-iteration-count:infinite;-webkit-animation-direction:alternate;-webkit-animation-timing-function:ease-in-out;-webkit-transform-origin:50% -100%}@-webkit-keyframes fade{0%{opacity:1}90%{opacity:1}100%{opacity:0}}@-webkit-keyframes drop{0%{-webkit-transform:translate(0,0)}100%{-webkit-transform:translate(0,736px)}}@-webkit-keyframes clockwiseSpin{0%{-webkit-transform:rotate(-100deg)}100%{-webkit-transform:rotate(100deg)}}@-webkit-keyframes counterclockwiseSpinAndFlip{0%{-webkit-transform:scale(-1.2,1.2) rotate(50deg)}100%{-webkit-transform:scale(-1.2,1.2) rotate(-50deg)}}.scroll_nav{position:fixed;top:45%;left:50%;-webkit-transform:translate(-50%);width:218px;height:26px;background:url(//a-h5.mtq.tvm.cn/yao/common/img/font.png) no-repeat;background-size:100%;text-align:center}.scroll_nav img{width:56px;margin-top:-10px}@keyframes lineR{0%{-webkit-transform:rotate(0)}25%{-webkit-transform:rotate(-20deg)}50%{-webkit-transform:rotate(0)}75%{-webkit-transform:rotate(20deg)}100%{-webkit-transform:rotate(0)}}@-webkit-keyframes lineR{0%{-webkit-transform:rotate(0)}25%{-webkit-transform:rotate(-20deg)}50%{-webkit-transform:rotate(0)}75%{-webkit-transform:rotate(20deg)}100%{-webkit-transform:rotate(0)}}.lineR{-webkit-animation:lineR .4s linear infinite;animation:lineR .4s linear infinite}';
		var CSS_a='.popup .redPack div{padding-top:.12rem;height:4.7rem;background:url(//a-h5.mtq.tvm.cn/yao/common/img/redBlock.gif) no-repeat #db5c48 left bottom;background-size:100%}.popup .redPack h4{margin-bottom:.76rem}.popup .redPack .explain{color:#8b2515;text-align:center;font-size:.24rem;line-height:.3rem}.popup .redPack .money{color:#fff;text-align:center;font-size:1.3rem}.popup .redPack .money span{color:#8b2515;font-size:.4rem}.popup .redPack .bottomText{position:absolute;bottom:.2rem;left:50%;margin-left:-2.32rem;width:4.64rem;height:.9rem;border-radius:.1rem;color:#ffbc64;text-align:center;font-size:.3rem;line-height:.9rem}.redPacketCon{background:#fff;height:100%;width:100%;position:absolute}.redPacketCon .redBag{width:100%;height:1.97rem;background:url(//a-h5.mtq.tvm.cn/yao/common/img/a_redBag.png) no-repeat;background-size:100%;position:absolute;left:0;top:0}.redPacketCon .redBag>h3{margin-top:.28rem;line-height:.38rem;color:#ffbc64;text-align:center;font-size:.3rem}.redPacketCon .person{width:1.46rem;height:1.46rem;border-radius:50%;overflow:hidden;position:absolute;left:50%;margin-left:-.73rem;bottom:0;margin-bottom:-.73rem}.redPacketCon p.name{line-height:.38rem;margin-top:2.8rem;text-align:center;font-size:.26rem;color:#010101;margin-bottom:.12rem}.redPacketCon p.getmoney{color:#000;font-size:1.3rem;line-height:1.42rem;text-align:center;overflow:hidden;max-height:1.42rem;max-width:7.5rem}.redPacketCon p.getmoney>span{font-size:.4rem;line-height:.7rem;margin-left:.05rem}.redPacketCon a.justify{text-decoration:none;color:#6f90cf;font-size:.26rem;line-height:.5rem;text-align:center;display:block;margin-bottom:.4rem}.redPacketCon p.agin{font-size:.28rem;color:#db5c48;line-height:.4rem;text-align:center}.popup .r_close{background:url(//a-h5.mtq.tvm.cn/yao/common/img/r_close.png) no-repeat;background-size:100% 100%;height:.3rem;width:.3rem;position:absolute;top:.3rem;left:.4rem;z-index:100}.popup{height:6.2rem;width:100%;background:#c04d3b;position:fixed;overflow:hidden;-webkit-transform:translate(0,150%);z-index:6;bottom:0;left:0;z-index:10006}.popup .close{background-image:url(//a-h5.mtq.tvm.cn/yao/common/img/closeBtn.png);background-size:100% 100%;height:.3rem;width:.3rem;position:absolute;top:.3rem;left:.4rem}.popup h3,.popup h4{font-weight:400;text-align:center}.popup h3{font-size:.4rem;line-height:.62rem;color:#ffbc64;padding-top:.11rem}.popup h4{font-size:.3rem;line-height:.48rem;color:#fff}.popup .btn{background:#ffbc64;width:4.64rem;height:.9rem;line-height:.9rem;text-align:center;color:#852b1d;font-size:.32rem;position:absolute;left:50%;-webkit-transform:translateX(-50%);bottom:.2rem;border-radius:.15rem}.popup .redPack div{height:4.7rem;background:url(//a-h5.mtq.tvm.cn/yao/common/img/redBlock.gif) no-repeat #db5c48 left bottom;background-size:100%;padding-top:.12rem}.popup .redPack h4{margin-bottom:.76rem}.popup .redPack .explain{color:#8b2515;font-size:.24rem;line-height:.3rem;text-align:center}.popup .redPack .money{font-size:1.3rem;color:#fff;text-align:center}.popup .redPack .money span{font-size:.4rem;color:#8b2515}.popup .redPack .bottomText{width:4.64rem;height:.9rem;border-radius:.1rem;color:#ffbc64;position:absolute;text-align:center;line-height:.9rem;left:50%;font-size:.3rem;margin-left:-2.32rem;bottom:.2rem}.ticket .explainText,.ticketPic .explainText{font-size:.3rem;color:#ffbc64;line-height:.8rem;text-align:center}.ticket h4{margin-bottom:.24rem}.ticket>div{background:#fff;box-sizing:border-box;padding-left:.24rem;border-radius:.1rem;width:7.16rem;margin:0 auto;text-align:left}.ticket table{border-collapse:collapse;border-spacing:0;height:100%;box-sizing:border-box}.ticket table td{-width:1.1rem}.ticket .left{width:1.1rem}.ticket .title{box-sizing:border-box;height:1.46rem;position:relative;border-bottom:1px solid #dedede;padding-top:.18rem;padding-bottom:.16rem;overflow:hidden}.ticket .title .left{float:left;height:1.1rem}.ticket .circle{background:#f0f0f0;position:relative;height:100%;width:100%;border-radius:50%}.ticket .circle img{position:absolute;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);width:60%}.ticket .explain{height:1.46rem;overflow:hidden;box-sizing:border-box;padding-top:.18rem;padding-bottom:.16rem}.ticket .explain .left img{max-height:1.08rem;max-width:80%}.ticket .title .right{float:left}.ticket .right{margin-left:.25rem;width:5.3rem}.ticket .right h3{font-size:.34rem;line-height:.52rem;color:#000;max-width:5.52rem;max-height:.52rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding-top:.09rem;text-align:left}.ticket .right .intro{font-size:.24rem;line-height:.44rem;max-width:5.52rem;max-height:.52rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ticket .pic{text-align:center}.ticket .explain .right{font-size:14px;color:#666;line-height:16px;max-height:46px;overflow:hidden}.ticketPic h4{margin-bottom:.3rem}.ticketPic div{max-height:2.94rem;overflow:hidden}.ticketPic div img{height:3rem;width:7.5rem}{height:100%;width:100%}.induce{width:4.75rem;height:3.17rem;background:rgba(0,0,0,.5);color:#fff;position:absolute;top:65%;left:50%;-webkit-transform:translate(-50%,-50%);overflow:hidden;text-align:center;z-index:998;border-radius:.2rem;display:none}.induce span{display:inline-block;background:url(//a-h5.mtq.tvm.cn/yao/common/img/induce.png);background-size:100% 100%;width:1.3rem;height:1.3rem;margin-top:.6rem}.induce p{line-height:1.08rem;font-size:.3rem}@-webkit-keyframes prizeComeIn{0%{-webkit-transform:translate(0,150%);opacity:0}50%{-webkit-transform:translate(0,75%)}100%{-webkit-transform:translate(0,0);opacity:1}}.popup.comeIn{-webkit-animation:prizeComeIn 500ms forwards ease-in}@-webkit-keyframes prizeComeOut{0%{-webkit-transform:translate(0,0);opacity:1}50%{-webkit-transform:translate(0,40%)}100%{-webkit-transform:translate(0,150%);opacity:0}}.popup.comeOut{-webkit-animation:prizeComeOut 500ms forwards ease-in}.ticket.apple>div{border-radius:4px;padding:.1rem;box-sizing:border-box;padding-left:3rem;position:relative;height:2.6rem;width:7.04rem;margin-top:.3rem}.ticket.apple>div .applemain{width:2.25rem;height:2rem;box-sizing:border-box;line-height:2rem}.ticket.apple>div .applemain img{max-width:100%;max-height:100%;vertical-align:middle}.apple .applemain{position:absolute;left:.15rem;top:50%;-webkit-transform:translateY(-50%)}.apple>div p{font-size:.28rem;line-height:.52rem}.apple .ti_tle{line-height:.52rem;height:.52rem;overflow:hidden;text-overflow:ellipsis;width:100%;white-space:nowrap;font-size:.35rem;padding-top:.4rem}.apple .money{color:#656565}.apple .money font{color:#8b8b8b;padding-left:.1rem;text-decoration:line-through}.apple .money1{color:#e80303}.apple .money1 .red{background:#e80303;color:#fff;padding:.02rem .08rem;border-radius:2px;margin-right:.1rem}div.popup{width:100%;border-radius:0;top:auto;left:0;bottom:0;-webkit-transform:inherit;margin:0;position:fixed}.apple .explainText{line-height:.98rem}.smartExpress{text-align:center;background:url(//qa-h5.mtq.tvm.cn/yao/common/img/txred_bg.jpg);height:100%;width:100%}.smartExpress div{background-image:url(//qa-h5.mtq.tvm.cn/yao/common/img/smartExpress.png);width:7.5rem;height:4.1rem;background-size:100% 100%}.smartExpress div h3{color:#ffbc64;font-size:.4rem;padding-top:0;line-height:.88rem;margin-bottom:.4rem}.smartExpress .money{font-size:1.3rem;line-height:1.34rem;height:1.34rem;color:#fff}.smartExpress .money span{font-size:.4rem;color:#8b2515}.smartExpress .text{color:#fff;font-size:.24rem;height:.56rem;line-height:.56rem}.smartExpress .tip01{font-size:.26rem;color:#ffbc64;line-height:1.03rem;height:1.03rem}.smartExpress .tip02{font-size:.3rem;color:#6f0f0f;height:.72rem;line-height:.72rem}';
		var CSS_i='.popup .redPack div{height:4.7rem;padding-top:.12rem;background:#db5c48 url(//a-h5.mtq.tvm.cn/yao/common/img/redBlock.gif) left bottom no-repeat;background-size:100% .79rem}.popup .redPack h4{margin-bottom:.5rem}.popup .redPack .explain{color:#8b2515}.popup .redPack .money{font-size:1.3rem;color:#fff}.popup .redPack .money span{font-size:.4rem;color:#8b2515}.popup .redPack .bottomText{position:absolute;bottom:0.8rem;font-size:.3rem;color:#ffbc64;left:50%;-webkit-transform:translateX(-50%);width:100%;bottom:1.15rem}.redPacketCon{background:#fff;height:100%;width:100%;position:absolute}.redPacketCon .redBag{width:100%;height:2.2rem;background:url(//a-h5.mtq.tvm.cn/yao/common/img/redBag.png) no-repeat;background-size:100%;position:absolute;left:0;top:0}.redPacketCon .redBag>h3{margin-top:.28rem;line-height:.38rem;color:#ffbc64;text-align:center;font-size:.3rem}.redPacketCon .person{width:1.46rem;height:1.46rem;border-radius:50%;overflow:hidden;position:absolute;left:50%;margin-left:-.73rem;bottom:0;margin-bottom:-.73rem}.redPacketCon p.name{line-height:.62rem;margin-top:3rem;text-align:center;font-size:.26rem;color:#010101}.redPacketCon p.getmoney{color:#000;font-size:1.3rem;line-height:1.42rem;text-align:center;overflow:hidden;max-height:1.42rem;max-width:6.3rem}.redPacketCon p.getmoney>span{font-size:.4rem;line-height:.7rem;margin-left:.05rem}.redPacketCon a.justify{text-decoration:none;color:#6f90cf;font-size:.26rem;line-height:.44rem;text-align:center;display:block;margin-bottom:.6rem}.redPacketCon p.agin{font-size:.28rem;color:#db5c48;line-height:.38rem;text-align:center}.popup .r_close{background:url(//a-h5.mtq.tvm.cn/yao/common/img/r_close.png) no-repeat;z-index:100;background-size:100% 100%;height:.3rem;width:.3rem;position:absolute;top:.3rem;left:.4rem}.popup{height:6.78rem;width:6.33rem;background:#c04d3b;position:absolute;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);z-index:10006;text-align:center;border-radius:.2rem;overflow:hidden}.popup .close{background-image:url(//a-h5.mtq.tvm.cn/yao/common/img/closeBtn.png);background-size:100% 100%;height:.3rem;width:.3rem;position:absolute;top:.3rem;left:.4rem}.popup h3,.popup h4{font-weight:400}.popup h3{font-size:.4rem;line-height:.6rem;color:#ffbc64;padding-top:.2rem}.popup h4{font-size:.3rem;line-height:.54rem;color:#fff}.popup .btn{background:#ffbc64;width:4.64rem;height:.9rem;line-height:.9rem;text-align:center;color:#852b1d;font-size:.32rem;position:absolute;left:50%;-webkit-transform:translateX(-50%);bottom:.2rem;border-radius:.15rem}.ticket .explainText,.ticketPic .explainText{font-size:.3rem;color:#ffbc64;line-height:1.2rem}.ticket h4{margin-bottom:.24rem}.ticket>div{background:#fff;border-radius:.1rem;width:6.04rem;padding:.37rem 0 .27rem 0;margin:0 auto;text-align:left}.ticket table{border-collapse:collapse;border-spacing:0}.ticket .left{width:1.1rem;margin-left:.25rem}.ticket .title{position:relative;border-bottom:1px solid #dedede;padding-bottom:.14rem;overflow:hidden}.ticket .title .left{float:left;height:1.1rem}.ticket .circle{background:#f0f0f0;position:relative;height:100%;width:100%;border-radius:50%}.ticket .circle img{position:absolute;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);width:60%}.ticket .explain{padding-top:.14rem}.ticket .explain .left img{max-height:1.08rem;max-width:80%}.ticket .title .right{float:left}.ticket .right{margin-left:.21rem;width:4.08rem}.ticket .right h3{font-size:.34rem;line-height:.7rem;color:#000;padding-top:0}.ticket .right .intro{font-size:.24rem;line-height:.26rem}.ticket .pic{text-align:center}.ticket .explain .right{font-size:14px;color:#666;line-height:16px;max-height:46px;overflow:hidden}.ticketPic h4{margin-bottom:.3rem}.ticketPic div{max-height:2.94rem;overflow:hidden;}.ticketPic div img{height:3rem;width:7.5rem}.induce{width:4.75rem;height:3.17rem;background:rgba(0,0,0,.5);color:#fff;position:absolute;top:65%;left:50%;-webkit-transform:translate(-50%,-50%);overflow:hidden;text-align:center;z-index:998;border-radius:.2rem;display:none}.induce span{display:inline-block;background:url(//a-h5.mtq.tvm.cn/yao/common/img/induce.png);background-size:100% 100%;width:1.3rem;height:1.3rem;margin-top:.6rem}.induce p{line-height:1.08rem;font-size:.3rem}@-webkit-keyframes prizeComeIn{0%{-webkit-transform:scale(0,0);opacity:0}60%{-webkit-transform:scale(1.2,1.2)}100%{-webkit-transform:scale(1,1);opacity:1}}.popup.comeIn{-webkit-animation:prizeComeIn 500ms forwards ease-out}@-webkit-keyframes prizeComeOut{0%{-webkit-transform:scale(1,1);opacity:1}20%{-webkit-transform:scale(1.2,1.2)}100%{-webkit-transform:scale(0,0);opacity:0}}.popup.comeOut{-webkit-animation:prizeComeOut 500ms forwards ease-out}.ticket.apple>div{border-radius:4px;padding:.1rem;box-sizing:border-box;padding-left:2.6rem;position:relative;height:2.6rem;margin-top:.5rem}.ticket.apple>div .applemain{width:2.25rem;height:2rem;box-sizing:border-box;line-height:2rem}.ticket.apple>div .applemain img{max-width:100%;max-height:100%;vertical-align:middle}.apple .applemain{position:absolute;left:.15rem;top:50%;-webkit-transform:translateY(-50%)}.apple>div p{font-size:.28rem;line-height:.52rem}.apple .ti_tle{font-size:.35rem;line-height:.52rem;height:.52rem;overflow:hidden;text-overflow:ellipsis;width:100%;white-space:nowrap;padding-top:.4rem}.apple .money{color:#656565}.apple .money font{color:#8b8b8b;padding-left:.1rem;text-decoration:line-through}.apple .money1{color:#e80303}.apple .money1 .red{background:#e80303;color:#fff;padding:.02rem .08rem;border-radius:2px;margin-right:.1rem}.apple .explainText{line-height:0.98rem;}';
		//判断ios还是Android
		...
		//if(OS=="android"){setStyle(CSS_s+CSS_a)}else{setStyle(CSS_s+CSS_i)};
		setStyle(CSS_s+CSS_a)
		var bool=true,archInfo=null,countIndex=0,onSwitch=true,shakeArr=[],likeArr=[],totalBool=false,totalSwitch=true,s_timer=null;
		...
		setTimeout(function(){
			...
			var bgBack=createNode(json.container,'p',{style:'top:0;z-index:0;background:#000;position:absolute;height:100%;width:100%;opacity:0;'},'p3');
			...
			var windowDiv=createNode(DB,'div',{className:'window',style:'height:100%;width:100%;background:rgba(0,0,0,0);position:absolute;top:0;left:0;z-index:10001;'},'p3');
			addEvent(windowDiv,'click',function(e){noPop(e)})
			addEvent(windowDiv,'touchstart',function(e){noPop(e)})
			addEvent(windowDiv,'touchmove',function(e){noPop(e)})
			addEvent(windowDiv,'touchend',function(e){noPop(e)})
			addEvent(windowDiv,'mousemove',function(e){noPop(e)})
			addEvent(windowDiv,'mouseover',function(e){noPop(e)})
			addEvent(windowDiv,'mouseout',function(e){noPop(e)})
			var makeVow=createNode(DB,'div',{className:'makeVow',html:'<img class="before" src="'+PAGE.COMMON+'img/makeVow.gif" style="display:none"><img class="after" src="'+PAGE.COMMON+'img/makeVowBg.png" style="display:none">'},'p3'); 
			var enterCon=createNode(DB,'div',{className:'enterCon up',html:'<input placeholder="最多输入6个字符哦" type="text" style="display:none;-webkit-user-modify:read-write-plaintext-only;-webkit-tap-highlight-color:rgba(0,0,0,0)">'},'p3');
			var mainAdBox=mainVar.ele.mainAdBox;
			var enter=enterCon.querySelector('input');
			//var scrollTopVal=DB.scrollHeight-winH;
			if(mainVar.banquan)mainVar.banquan.style.display="none";
			function showInputMethod(e){
				noPop(e);
				enterCon.className="enterCon down";
				totalSwitch=false;
				clearInterval(s_timer);
				var popContainer=mainVar.ele.popup;
				if(popContainer){
					popContainer.className="popup comeOut";
					setTimeout(function(){
						if(popContainer){removeNode(popContainer);popContainer=null;mainVar.ele.popup=null;};
					},500);
				};
				setTimeout(function(){
					DB.scrollTop=1000;
			...
			addEvent(enter,"focus",showInputMethod);
			function request(){
				var keyWord=enter.value;
				enter.value='';enterCon.className="enterCon up";DB.scrollTop=0;
				//JS文件测试环境地址：http://alpha.dsp.tvm.cn/demo/etag/v0.4/tvme-0.4.js //正式CDN文件地址：https://e-cdn.yaotv.tvm.cn/cdn/etag/tvme-0.4.js
				if(tvmE){
					var tvme=new tvmE();	
					tvme.getadbysearch(keyWord,(mainVar.mainData.column_info?mainVar.mainData.column_info.column_id:1),mainVar.mainData.time_interval_id,mainVar.userInfo.openid,mainVar.userInfo.nickname,mainVar.userInfo.sex,function($data){
						var _data=toObject($data),data='';
						if(_data.errcode==0){
							var data=_data.data,arr=[];
				...
				induce.querySelector('p').innerHTML='许愿成功，再摇摇看！';
				induce.style.display="block";
				setTimeout(function(){
					induce.style.display="none";
					onSwitch=true;
					totalSwitch=true;
				},1000);
			};
			if(OS=="android"){
				...
				addEvent(enter,"blur",function(e){
					if(e.keyCode==0&&limit()){
						request()	
					};
					noPop(e);
				});
			...
			function limit(){
				var len=enter.value.length,max=6
				enter.blur();
				if(len>max){
					enter.value='';
					tishi('最多可输入'+max+'个字！',{time:3000});
					enterCon.className="enterCon up";
					totalSwitch=true;
					DB.scrollTop=0;
					return false
				};
				if(len==0||enter.value==''){
					enterCon.className="enterCon up";
					totalSwitch=true;
					DB.scrollTop=0;
					return false;
			...
			function startGame(){
				...
				if(bool){
					bool=false;
					var popup=mainVar.ele.popup;
					if(popup)popup.className="popup comeOut";
					s_timer=setTimeout(function(){
						mainVar.ele.popup&&removeNode(mainVar.ele.popup);
						mainVar.ele.popup=null;
						getCoinNum();
					},2000)
				};
			};
			...
			function getCoinNum(){
				...
				AjaxFn({
					type:'get',
					url:HOST.CJ+"/open/balanceActivity/draw?lotteryid="+mainVar.prizeID+"&yyyappId="+PAGE.yyyappid+"&code="+user.sig+"&openId="+user.openid+"&sigExpire="+user.sigExpire+"&icon="+user.headimg+"&name="+user.nickname+"&sex="+user.sex+"&country="+user.country+"&province="+user.province+"&city="+user.city,
					success:function($data){
						...
						if(data&&data.code==1&&(data.balance||data.cash)){
							...
							if(data.balance){
								popup(0,coinNumber); //余额红包
								mainVar.warter.shareTag("余额红包");
								tjData.album_name=coinNumber+"元余额红包";
							}else{
								if(data.type==103){
									popup(4,coinNumber); //奖励红包
								}else{
									popup(5,coinNumber); //余额锦囊任务红包
								};
								mainVar.warter.shareTag("现金红包");
			...
			function showCard(){
				...
				tjData.album_name=archInfo.title;
			...
			var y_timer=setInterval(function(){
				if(indexTime<=15){
					...
					setStorage('set','likeArr',JSON.stringify(likeArr));
					for(var i=0,len=likeArr.length;i<len;i++){
						for(var k=0;k<mainVar.reccards.length;k++){
							if(mainVar.reccards[k].id==likeArr[i].id){
								mainVar.reccards.splice(k,1);
							};
						};
					};
					setStorage('set','originArr',JSON.stringify(mainVar.reccards));
				};
				indexTime--;
			},1000);
			function popup(num,data){
				var str='',oClass='close';
				switch(num){
					case 0:
						 str='<div class="redPack">\
							<div>\
								...
								<p class="explain">已存入您的余额账户，请到个人中心进行查看</p>\
							</div>\
						...
						oClass='r_close';
						 str='<div class="redPacketCon">\
								<div class="redBag">\
								  ...
								  <a class="justify" href="javascript:void(0);">已存入您 的中奖记录，请到个人中心进行领取</a>\
								  <p class="agin">人品大爆发，继续接着摇！</p>\
						 	  </div>';
					break;
					case 1:
						 str='<div class="ticket" data-flag="ticket">\
								<h3>摇一摇有惊喜</h3>\
								<h4>恭喜您摇到一张礼券</h4>\
								<div>\
					...
					break;
					case 2:
						 str='<div class="ticketPic" data-flag="ticket">\
								<h3>摇一摇有惊喜</h3>\
								<h4>恭喜您摇到一张礼券</h4>\
								<div>\
									<img src="'+getImg(data.banner_big)+'">\
								</div>\
								<p class="explainText">手气超赞，领完记得再摇！</p>\
								<span class="btn">先收藏 待会看</span>\
							</div>';
					...
					case 3:
						var isHide='none';
						 if(data.originprice){isHide='inline-block'};
						 str='<div class="ticket apple" data-flag="ticket">\
							<h3>摇一摇有惊喜</h3>\
							<h4>恭喜您摇到一次优惠机会</h4>\
							<div>\
								<div class="applemain">\
								...
								<p class="ti_tle">'+data.title+'</p>\
								<p class="money">￥'+data.price+' <font style="display:'+isHide+';">原价'+data.originprice+'</font></p>\
								<p class="money1"><font class="red">返</font> '+data.cash+'元</p>\
								<p class="money1" style="display:none;">实际只要 ￥</p>\
							</div>\
							<p class="explainText">手气超赞，领完记得再摇！</p>\
							<span class="btn">先收藏 待会看</span>\
						</div>';
				...
				if(totalBool)return;
				var popContainer=mainVar.ele.popup=createNode(DB,'div',{className:'popup comeIn',html:str+'<span class="'+oClass+'"></span>'},'p3');
				bool=true;onSwitch=false;
				setTimeout(function(){
					onSwitch=true;
				},2000);
				//if(OS!='android'){popContainer.style.margin='-'+popContainer.offsetHeight/2+'px 0 0 -'+popContainer.offsetWidth/2+'px'};
				var firstElem=popContainer.children[0];
				var closeBtn=popContainer.children[1];
				addEvent(popContainer,'touchstart',function(e){noPop(e)});   
				if(firstElem.getAttribute('data-flag')=='ticket'){
					//点击存入我的卡券包
					addEvent(firstElem.querySelector('.btn'),'touchstart',function(e){
						noPop(e);
						if(likeArr.length){
							likeArr.pop();
						};
						...
						if(len){
							...
							if(judge){
								mainVar.ticketInfo.push(archInfo.tag);
								shakeArr.push(cur);
							};
						}else{
							shakeArr.push(cur);
				...
				function saveCard(listData){
					...
					switch(+matchingPrize.type){
						case 6:
							...
							matchingPrize['cash']=listData.cash;matchingPrize['price']=listData.price;matchingPrize['originprice']=listData.originprice;
						break;
						case 7:
				...
				function disappear(parm){
					popContainer.className="popup comeOut";
					setTimeout(function(){
						if(popContainer){removeNode(popContainer);popContainer=null;mainVar.ele.popup=null;};
						if(parm){
							induce.querySelector('p').innerHTML='已放入您的收藏';
							induce.style.display="block";
							setTimeout(function(){
								induce.style.display="none";
								onSwitch=bool=true;
...
,JINGCAI:function($options){
	...
	,INTERACTIVE:function(sceneData,arr,type,counter_name){
		...
		switch(type){
			case 0:
				...
				setStyle(CSS);
				var color=['#2c9cce','#e42b79'],r=Math.random()*mainVar.peopleCount>>0,a=mainVar.peopleCount-r,b=r;
				autoFn=function(){
					...
					countAction({method:'queryCounter',dom:mainVar.ele,counterName:counter_name},function($data){
						...
						if(data.errCode=='0'){
							...
							options={optaNum:a,optbNum:b+=Math.random()*10>>0}
							if(!options)return;
							...
							for(var i=0;i<arr.length;i++){
								...
								if(isNaN(percent)||arr[i].num==undefined){
									return;
								};
							};
			...
			case 2:
				...
				autoFn=function(){
					...
					countAction({method:'queryCounter',dom:mainVar.ele,counterName:'点赞人数'},function($data){
						var data=toObject($data);
						if(data.errCode=='0'){
							var nums=toObject(data.result),options=nums.options,count=0;options.optbNum=mainVar.peopleCount+options.optbNum*6
							if(!options)return;
							...
							try{
								textElem[0].innerHTML=options.optbNum;
								textElem[1].innerHTML=(zanCount||setStorage("get","zanCount"+gameTime,zanCount));
							}catch(e){ //容错
								mainVar.ele.percentage.querySelector('.text').innerHTML='累计点赞 <span>'+options.optbNum+'</span> 次<br>您共为ta点赞 <span>'+(zanCount||setStorage("get","zanCount"+gameTime,zanCount))+'</span> 次';
							};
						};
					});
				};
	...
	SHEQUBALANCE:function(json){
				var CSS_s='#coin_wrap{position:absolute;top:0;height:100%;width:100%;overflow:hidden;z-index:3}#coin_wrap>div{position:absolute;width:22px;height:22px;-webkit-animation-iteration-count:1,1;-webkit-animation-direction:normal,normal;-webkit-animation-timing-function:linear,ease-in}#coin_wrap>div>img{position:absolute;width:22px;height:22px;background-size:100% 100%;-webkit-animation-iteration-count:infinite;-webkit-animation-direction:alternate;-webkit-animation-timing-function:ease-in-out;-webkit-transform-origin:50% -100%}@-webkit-keyframes fade{0%{opacity:1}90%{opacity:1}100%{opacity:0}}@-webkit-keyframes drop{0%{-webkit-transform:translate(0,0)}100%{-webkit-transform:translate(0,736px)}}@-webkit-keyframes clockwiseSpin{0%{-webkit-transform:rotate(-100deg)}100%{-webkit-transform:rotate(100deg)}}@-webkit-keyframes counterclockwiseSpinAndFlip{0%{-webkit-transform:scale(-1.2,1.2) rotate(50deg)}100%{-webkit-transform:scale(-1.2,1.2) rotate(-50deg)}}.popupContainer{font:14px weiruanyahei,FZYQJW,"微软雅黑",Tahoma,"\534E\6587\5B8B\4F53",arial;}';
		var CSS_a='.popup .redPack div{padding-top:.12rem;height:4.7rem;background:url(//a-h5.mtq.tvm.cn/yao/common/img/redBlock.gif) no-repeat #db5c48 left bottom;background-size:100%}.popup .redPack h4{margin-bottom:.76rem}.popup .redPack .explain{color:#8b2515;text-align:center;font-size:.24rem;line-height:.3rem}.popup .redPack .money{color:#fff;text-align:center;font-size:1.3rem}.popup .redPack .money span{color:#8b2515;font-size:.4rem}.popup .redPack .bottomText{position:absolute;bottom:.2rem;left:50%;margin-left:-2.32rem;width:4.64rem;height:.9rem;border-radius:.1rem;color:#ffbc64;text-align:center;font-size:.3rem;line-height:.9rem}.redPacketCon{background:#fff;height:100%;width:100%;position:absolute}.redPacketCon .redBag{width:100%;height:1.97rem;background:url(//a-h5.mtq.tvm.cn/yao/common/img/a_redBag.png) no-repeat;background-size:100%;position:absolute;left:0;top:0}.redPacketCon .redBag>h3{margin-top:.28rem;line-height:.38rem;color:#ffbc64;text-align:center;font-size:.3rem}.redPacketCon .person{width:1.46rem;height:1.46rem;border-radius:50%;overflow:hidden;position:absolute;left:50%;margin-left:-.73rem;bottom:0;margin-bottom:-.73rem}.redPacketCon p.name{line-height:.38rem;margin-top:2.8rem;text-align:center;font-size:.26rem;color:#010101;margin-bottom:.12rem}.redPacketCon p.getmoney{color:#000;font-size:1.3rem;line-height:1.42rem;text-align:center;overflow:hidden;max-height:1.42rem;max-width:7.5rem}.redPacketCon p.getmoney>span{font-size:.4rem;line-height:.7rem;margin-left:.05rem}.redPacketCon a.justify{text-decoration:none;color:#6f90cf;font-size:.26rem;line-height:.5rem;text-align:center;display:block;margin-bottom:.4rem}.redPacketCon p.agin{font-size:.28rem;color:#db5c48;line-height:.4rem;text-align:center}.popup .r_close{background:url(//a-h5.mtq.tvm.cn/yao/common/img/r_close.png) no-repeat;background-size:100% 100%;height:.3rem;width:.3rem;position:absolute;top:.3rem;left:.4rem;z-index:100}.popup{height:6.2rem;width:100%;background:#c04d3b;position:fixed;overflow:hidden;-webkit-transform:translate(0,150%);z-index:6;bottom:0;left:0;z-index:10006}.popup .close{background-image:url(//a-h5.mtq.tvm.cn/yao/common/img/closeBtn.png);background-size:100% 100%;height:.3rem;width:.3rem;position:absolute;top:.3rem;left:.4rem}.popup h3,.popup h4{font-weight:400;text-align:center}.popup h3{font-size:.4rem;line-height:.62rem;color:#ffbc64;padding-top:.11rem}.popup h4{font-size:.3rem;line-height:.48rem;color:#fff}.popup .btn{background:#ffbc64;width:4.64rem;height:.9rem;line-height:.9rem;text-align:center;color:#852b1d;font-size:.32rem;position:absolute;left:50%;-webkit-transform:translateX(-50%);bottom:.2rem;border-radius:.15rem}.popup .redPack div{height:4.7rem;background:url(//a-h5.mtq.tvm.cn/yao/common/img/redBlock.gif) no-repeat #db5c48 left bottom;background-size:100%;padding-top:.12rem}.popup .redPack h4{margin-bottom:.76rem}.popup .redPack .explain{color:#8b2515;font-size:.24rem;line-height:.3rem;text-align:center}.popup .redPack .money{font-size:1.3rem;color:#fff;text-align:center}.popup .redPack .money span{font-size:.4rem;color:#8b2515}.popup .redPack .bottomText{width:4.64rem;height:.9rem;border-radius:.1rem;color:#ffbc64;position:absolute;text-align:center;line-height:.9rem;left:50%;font-size:.3rem;margin-left:-2.32rem;bottom:.2rem}.ticket .explainText,.ticketPic .explainText{font-size:.3rem;color:#ffbc64;line-height:.8rem;text-align:center}.ticket h4{margin-bottom:.24rem}.ticket>div{background:#fff;box-sizing:border-box;padding-left:.24rem;border-radius:.1rem;width:7.16rem;margin:0 auto;text-align:left}.ticket table{border-collapse:collapse;border-spacing:0;height:100%;box-sizing:border-box}.ticket table td{-width:1.1rem}.ticket .left{width:1.1rem}.ticket .title{box-sizing:border-box;height:1.46rem;position:relative;border-bottom:1px solid #dedede;padding-top:.18rem;padding-bottom:.16rem;overflow:hidden}.ticket .title .left{float:left;height:1.1rem}.ticket .circle{background:#f0f0f0;position:relative;height:100%;width:100%;border-radius:50%}.ticket .circle img{position:absolute;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);width:60%}.ticket .explain{height:1.46rem;overflow:hidden;box-sizing:border-box;padding-top:.18rem;padding-bottom:.16rem}.ticket .explain .left img{max-height:1.08rem;max-width:80%}.ticket .title .right{float:left}.ticket .right{margin-left:.25rem;width:5.3rem}.ticket .right h3{font-size:.34rem;line-height:.52rem;color:#000;max-width:5.52rem;max-height:.52rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding-top:.09rem;text-align:left}.ticket .right .intro{font-size:.24rem;line-height:.44rem;max-width:5.52rem;max-height:.52rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ticket .pic{text-align:center}.ticket .explain .right{font-size:14px;color:#666;line-height:16px;max-height:46px;overflow:hidden}.ticketPic h4{margin-bottom:.3rem}.ticketPic div{max-height:2.94rem;overflow:hidden}.ticketPic div img{height:3rem;width:7.5rem}{height:100%;width:100%}.induce{width:4.75rem;height:3.17rem;background:rgba(0,0,0,.5);color:#fff;position:absolute;top:65%;left:50%;-webkit-transform:translate(-50%,-50%);overflow:hidden;text-align:center;z-index:998;border-radius:.2rem;display:none}.induce span{display:inline-block;background:url(//a-h5.mtq.tvm.cn/yao/common/img/induce.png);background-size:100% 100%;width:1.3rem;height:1.3rem;margin-top:.6rem}.induce p{line-height:1.08rem;font-size:.3rem}@-webkit-keyframes prizeComeIn{0%{-webkit-transform:translate(0,150%);opacity:0}50%{-webkit-transform:translate(0,75%)}100%{-webkit-transform:translate(0,0);opacity:1}}.popup.comeIn{-webkit-animation:prizeComeIn 500ms forwards ease-in}@-webkit-keyframes prizeComeOut{0%{-webkit-transform:translate(0,0);opacity:1}50%{-webkit-transform:translate(0,40%)}100%{-webkit-transform:translate(0,150%);opacity:0}}.popup.comeOut{-webkit-animation:prizeComeOut 500ms forwards ease-in}.ticket.apple>div{border-radius:4px;padding:.1rem;box-sizing:border-box;padding-left:3rem;position:relative;height:2.6rem;width:7.04rem;margin-top:.3rem}.ticket.apple>div .applemain{width:2.25rem;height:2rem;box-sizing:border-box;line-height:2rem}.ticket.apple>div .applemain img{max-width:100%;max-height:100%;vertical-align:middle}.apple .applemain{position:absolute;left:.15rem;top:50%;-webkit-transform:translateY(-50%)}.apple>div p{font-size:.28rem;line-height:.52rem}.apple .ti_tle{line-height:.52rem;height:.52rem;overflow:hidden;text-overflow:ellipsis;width:100%;white-space:nowrap;font-size:.35rem;padding-top:.4rem}.apple .money{color:#656565}.apple .money font{color:#8b8b8b;padding-left:.1rem;text-decoration:line-through}.apple .money1{color:#e80303}.apple .money1 .red{background:#e80303;color:#fff;padding:.02rem .08rem;border-radius:2px;margin-right:.1rem}div.popup{width:100%;border-radius:0;top:auto;left:0;bottom:0;-webkit-transform:inherit;margin:0;position:fixed}.apple .explainText{line-height:.98rem}.smartExpress{text-align:center;background:url(//qa-h5.mtq.tvm.cn/yao/common/img/txred_bg.jpg);height:100%;width:100%}.smartExpress div{background-image:url(//qa-h5.mtq.tvm.cn/yao/common/img/smartExpress.png);width:7.5rem;height:4.1rem;background-size:100% 100%}.smartExpress div h3{color:#ffbc64;font-size:.4rem;padding-top:0;line-height:.88rem;margin-bottom:.4rem}.smartExpress .money{font-size:1.3rem;line-height:1.34rem;height:1.34rem;color:#fff}.smartExpress .money span{font-size:.4rem;color:#8b2515}.smartExpress .text{color:#fff;font-size:.24rem;height:.56rem;line-height:.56rem}.smartExpress .tip01{font-size:.26rem;color:#ffbc64;line-height:1.03rem;height:1.03rem}.smartExpress .tip02{font-size:.3rem;color:#6f0f0f;height:.72rem;line-height:.72rem}';
		var CSS_i='.popupContainer .redPack div{height:4.7rem;padding-top:.12rem;background:#db5c48 url(//a-h5.mtq.tvm.cn/yao/common_btv7/img/redBlock.gif) left bottom no-repeat;background-size:100% .79rem}.popupContainer .redPack h4{margin-bottom:.5rem}.popupContainer .redPack .explain{color:#8b2515}.popupContainer .redPack .money{font-size:1.3rem;color:#fff}.popupContainer .redPack .money span{font-size:.4rem;color:#8b2515}.popupContainer .redPack .bottomText{position:absolute;bottom:.8rem;font-size:.3rem;color:#ffbc64;left:50%;-webkit-transform:translateX(-50%);width:100%;bottom:1.15rem}.redPacketCon{background:#fff;height:100%;width:100%;position:absolute}.redPacketCon .redBag{width:100%;height:2.2rem;background:url(//a-h5.mtq.tvm.cn/yao/common_btv7/img/redBag.png) no-repeat;background-size:100%;position:absolute;left:0;top:0}.redPacketCon .redBag>h3{margin-top:.28rem;line-height:.38rem;color:#ffbc64;text-align:center;font-size:.3rem}.redPacketCon .person{width:1.46rem;height:1.46rem;border-radius:50%;overflow:hidden;position:absolute;left:50%;margin-left:-.73rem;bottom:0;margin-bottom:-.73rem}.redPacketCon p.name{line-height:.62rem;margin-top:3rem;text-align:center;font-size:.26rem;color:#010101}.redPacketCon p.getmoney{color:#000;font-size:1.3rem;line-height:1.42rem;text-align:center;overflow:hidden;max-height:1.42rem;max-width:6.3rem}.redPacketCon p.getmoney>span{font-size:.4rem;line-height:.7rem;margin-left:.05rem}.redPacketCon a.justify{text-decoration:none;color:#6f90cf;font-size:.26rem;line-height:.44rem;text-align:center;display:block;margin-bottom:.6rem}.redPacketCon p.agin{font-size:.28rem;color:#db5c48;line-height:.38rem;text-align:center}.popupContainer .r_close{background:url(//a-h5.mtq.tvm.cn/yao/common_btv7/img/r_close.png) no-repeat;z-index:100;background-size:100% 100%;height:.3rem;width:.3rem;position:absolute;top:.3rem;left:.4rem}.popupContainer {height:6.78rem;width:6.33rem;background:#c04d3b;position:fixed;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);z-index:10006;text-align:center;border-radius:.2rem;overflow:hidden}.popupContainer .close{background-image:url(//a-h5.mtq.tvm.cn/yao/common_btv7/img/closeBtn.png);background-size:100% 100%;height:.3rem;width:.3rem;position:absolute;top:.3rem;left:.4rem}.popupContainer h3,.popupContainer h4{font-weight:400}.popupContainer h3{font-size:.4rem;line-height:.6rem;color:#ffbc64;padding-top:.2rem}.popupContainer h4{font-size:.3rem;line-height:.54rem;color:#fff}.popupContainer .btn{background:#ffbc64;width:4.64rem;height:.9rem;line-height:.9rem;text-align:center;color:#852b1d;font-size:.32rem;position:absolute;left:50%;-webkit-transform:translateX(-50%);bottom:.2rem;border-radius:.15rem}.ticket .explainText,.ticketPic .explainText{font-size:.3rem;color:#ffbc64;line-height:1.2rem}.ticket h4{margin-bottom:.24rem}.ticket>div{background:#fff;border-radius:.1rem;width:6.04rem;padding:.37rem 0 .27rem 0;margin:0 auto;text-align:left}.ticket table{border-collapse:collapse;border-spacing:0}.ticket .left{width:1.1rem;margin-left:.25rem}.ticket .title{position:relative;border-bottom:1px solid #dedede;padding-bottom:.14rem;overflow:hidden}.ticket .title .left{float:left;height:1.1rem}.ticket .circle{background:#f0f0f0;position:relative;height:100%;width:100%;border-radius:50%}.ticket .circle img{position:absolute;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);width:60%}.ticket .explain{padding-top:.14rem}.ticket .explain .left img{max-height:1.08rem;max-width:80%}.ticket .title .right{float:left}.ticket .right{margin-left:.21rem;width:4.08rem}.ticket .right h3{font-size:.34rem;line-height:.7rem;color:#000;padding-top:0}.ticket .right .intro{font-size:.24rem;line-height:.26rem}.ticket .pic{text-align:center}.ticket .explain .right{font-size:14px;color:#666;line-height:16px;max-height:46px;overflow:hidden}.ticketPic h4{margin-bottom:.3rem}.ticketPic div{max-height:2.94rem;overflow:hidden;}.ticketPic div img{height:3rem;width:7.5rem}.induce{font:14px weiruanyahei,FZYQJW,"微软雅黑",Tahoma,"\534E\6587\5B8B\4F53",arial;width:4.75rem;height:3.17rem;background:rgba(0,0,0,.5);color:#fff;position:absolute;top:75%;left:50%;-webkit-transform:translate(-50%,-50%);overflow:hidden;text-align:center;z-index:3003;border-radius:.2rem;display:none}.induce span{display:inline-block;background:url(//a-h5.mtq.tvm.cn/yao/common_btv7/img/induce.png);background-size:100% 100%;width:1.3rem;height:1.3rem;margin-top:.6rem}.induce p{line-height:1.08rem;font-size:.3rem}@-webkit-keyframes prizeComeIn{0%{-webkit-transform:scale(0,0);opacity:0}60%{-webkit-transform:scale(1.2,1.2)}100%{-webkit-transform:scale(1,1);opacity:1}}.popupContainer.comeIn{-webkit-animation:prizeComeIn 500ms forwards ease-out}@-webkit-keyframes prizeComeOut{0%{-webkit-transform:scale(1,1);opacity:1}20%{-webkit-transform:scale(1.2,1.2)}100%{-webkit-transform:scale(0,0);opacity:0}}.popupContainer.comeOut{-webkit-animation:prizeComeOut 500ms forwards ease-out}.ticket.apple>div{border-radius:4px;padding:.1rem;box-sizing:border-box;padding-left:2.6rem;position:relative;height:2.6rem;margin-top:.5rem}.ticket.apple>div .applemain{width:2.25rem;height:2rem;box-sizing:border-box;line-height:2rem}.ticket.apple>div .applemain img{max-width:100%;max-height:100%;vertical-align:middle}.apple .applemain{position:absolute;left:.15rem;top:50%;-webkit-transform:translateY(-50%)}.apple>div p{font-size:.28rem;line-height:.52rem}.apple .ti_tle{font-size:.35rem;line-height:.52rem;height:.52rem;overflow:hidden;text-overflow:ellipsis;width:100%;white-space:nowrap;padding-top:.4rem}.apple .money{color:#656565}.apple .money font{color:#8b8b8b;padding-left:.1rem;text-decoration:line-through}.apple .money1{color:#e80303}.apple .money1 .red{background:#e80303;color:#fff;padding:.02rem .08rem;border-radius:2px;margin-right:.1rem}.apple .explainText{line-height:0.98rem;}';
		//判断ios还是Android
		var UA=navigator.userAgent.toLowerCase(),OSA=["windows","ipad","ipod","iphone","android"],OSL=OSA.length,OS=""
		while(OS=OSA.shift()){
			if(UA.indexOf(OS)>-1){
		...
		//if(OS=="android"){setStyle(CSS_s+CSS_a)}else{setStyle(CSS_s+CSS_i)};
		setStyle(CSS_s+CSS_a);
		var bool=true,archInfo=null,countIndex=0,onSwitch=true,totalBool=false,totalSwitch=true,s_timer=null;
		function fontSize(){DO.documentElement.style.fontSize=100*DO.documentElement.clientWidth/750+'px'};
		fontSize();
		var induce=createNode(DB,'div',{className:'induce',html:"<span></span><p>已放入您的收藏</p>"},'p3');
		var shakeTip=createNode(DB,'div',{className:'shakeTip shakeTipIn',html:'<img src="'+PAGE.COMMON+'img/shakeRedPacket.gif" style="height:100px;">'},'p3');
		function rule(){
			setTimeout(function(){
				shakeTip.className='shakeTip shakeTipOut';
				setTimeout(function(){
					shakeTip.className='shakeTip shakeTipIn';
					rule()
				},30e3);
			},6e3);
		};
		rule();
		setTimeout(function(){
			var coin_wrap=mainVar.ele.coin_wrap=createNode(DB,'div',{id:"coin_wrap",'style':'z-index:3001;pointer-events:none;'},'p3');
			var audioCon=createNode(DB,'audio',{src:json.voiceBand},'p3');
			function randomNum(minNum,maxNum){
				return parseInt(Math.random()*(maxNum-minNum+1)+minNum);
			};
			...
			function startGame(){
				...
				if(bool){
					bool=false;
					var popup=mainVar.ele.popup;
					if(popup)popup.className="popupContainer comeOut";
					s_timer=setTimeout(function(){
						mainVar.ele.popup&&removeNode(mainVar.ele.popup);
						mainVar.ele.popup=null;
						getCoinNum();
			...
			//setInterval(function(){startGame()},2000)
			function getCoinNum(){
				var user=mainVar.userInfo;
				AjaxFn({
					type:'get',
			...
			function popup(num,data){
				...
				switch(num){
					...
					case 2:
						 str='<div class="ticketPic" data-flag="ticket">\
								...
								<h4>恭喜您摇到一张礼券</h4>\
								<div>\
									<img src="'+data.banner_big+'">\
								</div>\
								<span class="btn">先收藏 待会看</span>\
							</div>';
					break;
					case 3:
						var sum=data.price-data.cash,isHide='block';
						if(sum<=0){
							isHide='none';
						};
						if(sum.toString().indexOf(".")!=-1){
						 ...
						 str='<div class="ticket apple" data-flag="ticket">\
							...
							<div>\
								...
								<p class="ti_tle">'+data.title+'</p>\
								<p class="money">￥'+data.price+' <font style="display:none;">原价'+data.price+'</font></p>\
								<p class="money1"><font class="red">返</font> '+data.cash+'元</p>\
								<p class="money1" style="display:none;">实际只要 ￥'+sum+'</p>\
							</div>\
							<p class="explainText">手气超赞，领完记得再摇！</p>\
							<span class="btn">先收藏 待会看</span>\
						</div>';
				...
				if(totalBool)return;
				var popContainer=mainVar.ele.popup=createNode(DB,'div',{className:'popupContainer comeIn',html:str+'<span class="'+oClass+'"></span>'},'p3');
				bool=true;onSwitch=false;
				setTimeout(function(){
					onSwitch=true;
				},2000);
				...
				function saveCard(listData){
					...
					switch(+matchingPrize.type){
						case 6:
							matchingPrize.type=6
							matchingPrize['cash']=listData.cash;matchingPrize['price']=listData.price;
						break;
						case 7:
							matchingPrize.type=7;
						break;
