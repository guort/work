	...
	chars:{
		myhome:{//个人中心
			...
			,homes:{
				...
				,financing:'http://qa.pmall.yaotv.tvm.cn/sales/dist/finance/index.html'	//理财
			}
			,menu:{
				wintake:1		//中奖纪录
				,card:1			//我的收藏
...
mainVar={userInfo:null,ele:{},game:{},module:{},mainData:{},times:{},adData:{},sceneData:{},mzArr:[],location:{gps:"0,0",region:"0-0-0-0",adcode:0}}
function noUser(){
